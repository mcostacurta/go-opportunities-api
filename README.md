# GoJobOpportunities API

This project simple but complete opportunities API. Powered by Go-Gin as a router and GoORM for database comunication, SQLLite as the database, Swagger for API documentation.

Everything can be up and runing easily using Docker and Air to live-reloading.
...
1. Clone the repository: `git clone https://github.com/mcostacurta/go-opportunities-api.git`
...
- [Air](https://github.com/air-verse/air) for live-rolading
...
This project was created by [mcostacurta](https://github.com/mcostacurta) based on another project made by [arthur404dev](https://github.com/arthur404dev) reference link [video](https://www.youtube.com/watch?v=wyEYpX5U4Vg&t=3s)